            ...
            <div className="lg:pr-4 my-10">
              <div className="lg:max-w-lg my-10 ">
                ...
                <p className=" text-justify leading-8  mt-6 text-lg  px-5">
                  At <strong className="text-[red]">FUTCA</strong>, Our vision
                  is to lead the way in the digital transformation of
                  industries, creating a future where technology empowers
                  organizations to achieve their full potential. We envision a
                  world where businesses thrive in the digital age, leveraging
                  the latest advancements in technology to fuel innovation and
                  drive positive change. excellence.
                </p>
