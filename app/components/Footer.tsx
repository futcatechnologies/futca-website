...
const Footer = () => {
  return (
    <footer
      className="bg-white border-t-2 mt-10"
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            <img className="h-20" src="/images/logo.png" alt="Company name" />
            <p className="text-sm leading-6 text-gray-600">
              Revolutionizing the digital landscape with cutting-edge solutions
              and innovative technologies, empowering businesses to thrive in
              the digital era.
            </p>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-500">
            &copy; {new Date().getFullYear()} Futca Technology Limited. All
            rights reserved.
          </p>
        </div>
      </div>
