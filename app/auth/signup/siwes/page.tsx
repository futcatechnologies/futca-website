...
const initialFormData: SIWESFormData = {
  username: "",
  email: "",
  password: "",
  gender: "",
...
const SIWESForm: React.FC = () => {
  const [formData, setFormData] = useState<SIWESFormData>(initialFormData);
